...
zstyle :compinstall filename '/cygdrive/c/Users/Noname/.zshrc'
...
#第一プロンプトをカスタマイズ
#Cygdriveが面倒なので何とかする
#DropBoxをHomeフォルダにするなどの処置
#DropBoxで少なくとも設定ファイルを同期する。
###
...
setopt auto_param_slash	  # ディレクトリの補完の際に自動で末尾にスラッシュ追加
...
# 一般ユーザ時
tmp_prompt="%{${fg[gray]}%}(%M@%n) [%!] %# %{${reset_color}%}"
tmp_prompt2="%{${fg[blue]}%}%_> %{${reset_color}%}"
